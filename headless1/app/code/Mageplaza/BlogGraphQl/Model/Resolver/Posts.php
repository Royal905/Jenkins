...
class Posts implements ResolverInterface
{
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        switch ($args['action']) {
            ...
            case 'get_post_by_id':
                ...
                $collection = $this->getPostViewById($args);
                break;
     ...
     * @throws GraphQlInputException
     */
    protected function getPostViewById($args): AbstractCollection
    {
        if (!isset($args['postId'])) {
            throw new GraphQlInputException(__('postId should not be null'));
        }
        $collection = $this->_helperData->getFactoryByType()->create()->getCollection();
       

        $collection->addFieldToFilter('post_id', $args['postId']);
