...
namespace FS\SocialIconsGraphQl\Model\Resolver;
...
class SocialIconsRecords implements ResolverInterface
{
    ...
    public function __construct(
        \FS\SocialIconsGraphQl\Model\Resolver\DataProvider\SocialIconsRecords $brandRecords,
